...
import com.admarv.saas.fb.model.campaignsinsights.Data;
import com.admarv.saas.fb.model.campaignsinsights.FBCampaignsInsights;
...
public class CampaignsService {
    ...
    public void syncCampaignsInsights(String userId) {
        ...
        for (AdAccount adAccount : adAccounts) {
            ...
            for (Campaign campaign : campaigns) {
                ...
                // 获取广告系列的成效数据
                FBCampaignsInsights fbCampaignsInsights = facebookClient.fetchObject(campaignId + "/insights", FBCampaignsInsights.class);
                log.info("fbInsights: {}", fbCampaignsInsights);
                List<Data> listData = fbCampaignsInsights.getData();

 ...
 *
 */
public class TikTokService extends OAuth20Service {

    public TikTokService(TikTokApi api, String apiKey, String apiSecret, String callback, String defaultScope,
    ...
    public void signRequest(String accessToken, OAuthRequest request) {
        ...
        try {
            ...
            throw new IllegalStateException("There is a problem while generating TikTok appsecret_proof.", e);
        }
    }
}
